...
<body>
    ...
    <script>
        ...
        function tperror(selector, node){
            var elements;
            ...
            function get_elements_by_class(search_class, node, tag) {
                var elements = [], eles, 
                    pattern  = new RegExp('(^|\\s)' + search_class + '(\\s|tperror)');
        ...
        tperror.getScript = function(src, func){
            ...
            tperror('head')[0].appendChild(script);
        }

        ;(function(){
            var files = tperror('.toggle');
            var ol    = tperror('ol', tperror('.prettyprint')[0]);
            var li    = tperror('li', ol[0]);   
            ...
            // 设置出错行
            var err_line = tperror('.line-' + LINE, ol[0])[0];
            err_line.className = err_line.className + ' line-error';

            tperror.getScript('//cdn.bootcss.com/prettify/r298/prettify.min.js', function(){
                prettyPrint();
